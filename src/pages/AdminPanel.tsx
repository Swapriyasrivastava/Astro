                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'dashboard' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'orders' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'horoscopes' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'about' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'blog' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'contact' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'kundli' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                      <Star className="h-4 w-4" />
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'users' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'content' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                      <FileText className="h-4 w-4" />
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'payments' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                ...
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className={`hover:bg-cosmic-light/20 transition-all duration-300 ${currentView === 'settings' ? 'text-cosmic-light bg-cosmic-light/20' : 'text-cosmic-accent'}`}
                    >
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      ...
                      className="hover:bg-cosmic-light/20 transition-all duration-300 text-cosmic-accent"
                    >
          ...
          <SidebarFooter>
            <div className="p-2">
              <Button
                onClick={logout}
                variant="outline"
                className="w-full justify-start text-cosmic-light hover:bg-cosmic-light/20 hover:text-cosmic-light/90 btn-hover-effect animate-border-glow border-cosmic-light/30"
              >
