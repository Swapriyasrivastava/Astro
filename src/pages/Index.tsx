  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col justify-start items-center pt-24">
      ...
      <div className="container mx-auto px-4 text-center max-w-2xl z-10 flex flex-col items-center">
        ...
        <p className="text-lg md:text-xl text-cosmic-light mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          Enter the cosmic realm to manage your celestial dashboard.
        </p>
        
        <Button
          onClick={() => setIsAuthModalOpen(true)}
          className="bg-cosmic text-white hover:bg-cosmic-light font-semibold px-10 py-6 text-xl animate-fade-in mt-2 mb-8 btn-hover-effect shadow-lg"
