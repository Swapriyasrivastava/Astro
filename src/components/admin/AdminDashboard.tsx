  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="cosmic-glass">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Package className="h-4 w-4 text-cosmic-accent" />
          </CardHeader>
          <CardContent>
        ...
        <Card className="cosmic-glass">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <ShoppingCart className="h-4 w-4 text-cosmic-accent" />
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="cosmic-glass lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-cosmic-light">Revenue Report</CardTitle>
              <select className="bg-cosmic-dark/30 border-cosmic-light/20 text-cosmic-light rounded-md p-1 text-xs">
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={revenueData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <Area type="monotone" dataKey="expense" stroke="#FF9966" fillOpacity={1} fill="url(#colorExpense)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="h-[230px] relative">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                ...
                <div className="text-lg font-bold text-cosmic-light">45,000</div>
              </div>
            </div>
            <div className="mt-2">
        ...
        <Card className="cosmic-glass lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-cosmic-accent text-xs hover:underline">View All</a>
            </div>
          </CardHeader>
          <CardContent>
            <Table>
              ...
              <TableBody>
                {recentOrders.map((order) => (
                  <TableRow key={order.id} className="hover:bg-cosmic-dark/20 border-cosmic-light/10">
          ...
          <CardContent>
            <div className="space-y-4">
              {transactions.map((transaction) => (
                <div key={transaction.id} className="flex items-center justify-between p-2 rounded-lg hover:bg-cosmic-dark/20 transition-colors">
                  <div className="flex items-center">
